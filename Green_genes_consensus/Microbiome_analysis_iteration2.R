...
setwd("/DATA/home/jmlazaro/Projects/Microbiome/Minimap_Aligned_gg_13_5/Iteration2")
...
Grouped_Taxa_msa_filter = Combined_Taxa_count
Grouped_Taxa_msa_filter$group =paste0(Grouped_Taxa_msa_filter$Family,
                                      "|",Grouped_Taxa_msa_filter$Genus,"|",Grouped_Taxa_msa_filter$Species.y,
                                      "|",Grouped_Taxa_msa_filter$Species)

#Grouped_Taxa_msa_filter_group <- Grouped_Taxa_msa_filter %>% group_by(group) %>% top_n(2, Average_mq)
Grouped_Taxa_msa_filter_group <- Grouped_Taxa_msa_filter %>% group_by(group) %>% slice_max(counts_mq10,n = 2)

gg_new_fasta_id_list = as.character(Grouped_Taxa_msa_filter_group$gg_id)
...
writeXStringSet(New_Microbiome_Fasta, "New_Microbiome_Fasta_iteration2.fas")
